export const costaRicaLocations = {
  "San Jose": {
    "San Jose": [
      "Carmen",
      "Merced",
    ...
    Moravia: ["San Vicente", "San Jeronimo", "Trinidad"],
    ...
    "Leon Cortes": ["San Pablo", "San Andres", "Llano Bonito", "San Isidro", "Santa Cruz", "San Antonio"]
  },
  Alajuela: {
    Alajuela: [
      "Alajuela",
    ...
    Naranjo: ["Naranjo", "San Miguel", "San Jose", "Cirri Sur", "San Jeronimo", "San Juan", "Rosario", "Palmitos"],
    ...
    "Los Chiles": ["Los Chiles", "Cano Negro", "El Amparo", "San Jorge"],
  ...
  Cartago: {
    ...
    Jimenez: ["Juan Vinas", "Tucurrique", "Pejibaye", "La Victoria"],
  ...
  Heredia: {
    ...
    Barva: ["Barva", "San Pedro", "San Pablo", "San Roque", "Santa Lucia", "San Jose de la Montana", "Puente Salas"],
    ...
    Belen: ["San Antonio", "Rivera", "Asuncion"],
    Flores: ["San Joaquin", "Barrantes", "Llorente"],
    "San Pablo": ["San Pablo", "Rincon de Sabanilla"],
    Sarapiqui: ["Puerto Viejo", "La Virgen", "Horquetas", "Llanuras de Gaspar", "Curena"]
  },
  Guanacaste: {
  ...
  Puntarenas: {
    ...
    Golfito: ["Golfito", "Guaycara", "Pavon"],
    "Coto Brus": ["San Vito", "Sabalito", "Aguabuena", "Limoncito", "Pittier", "Gutierrez Braun"],
    Parrita: ["Parrita"],
    Corredores: ["Corredores", "La Cuesta", "Canoas", "Laurel"],
    Garabito: ["Jaco", "Tarcoles", "Lagunillas"],
